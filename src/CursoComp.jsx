                    ...
                    <div className="rating">
                        {() => {
                            ...
                            for (ratingTemp; index <= 5; ratingTemp--) {
                                if (ratingTemp !== 0) {
                                    comps.push((
                                        <img src="https://cdn.discordapp.com/attachments/1242519476633866313/1257352407159931051/full_star.png?ex=6684182e&is=6682c6ae&hm=2fa26ea2a3e02ccda8ef7ba94bfa1cfee61759c6f2ad13739ed2be60f3cf7bd4&" style={fullStar}/>
                                    ))
                                } else {
                                    comps.push((
                                        <img src="https://cdn.discordapp.com/attachments/1242519476633866313/1257352406828585051/empty_star.png?ex=6684182e&is=6682c6ae&hm=65876e643a21cf876ea4d9067bf8e33903f78a72c59b3937805e167a40bfbb3f&" style={emptyStar}/>
                                    ))
                                }
                                index++;
                            }
